...
depotr::book_ticket('broker','depot a','2021-02-04',isin='DE0008404005',trade=list(qty=+120,prc=201.05,ccy='EUR'),payment=list(type='fee',amount=-10,ccy='EUR'))
depotr::book_ticket('broker','depot a','2021-03-04',isin='DE0008404005',trade=list(qty= -60,prc=201.05,ccy='EUR'),payment=list(type='fee',amount=-10,ccy='EUR'))
